...
void precargarDatos(ArbolBST& arbol) {
    Estudiante e1 = {"1804567890", "Sanchez Perez", "Andrea Sofia", 8.5,
                     "Ingenieria en Software", "Tercer Nivel"};
    Estudiante e2 = {"1801234567", "Lopez Blanco", "Diego Andres", 9.2,
                     "Ingenieria en Software", "Tercer Nivel"};
    Estudiante e3 = {"1807654321", "Mendoza Alvarez", "Carla Elena", 6.3,
                     "Ingenieria en Software", "Tercer Nivel"};
    Estudiante e4 = {"1803456789", "Torres Mejia", "Ricardo Jose", 7.8,
                     "Ingenieria en Software", "Tercer Nivel"};
    Estudiante e5 = {"1809876543", "Rios Castro", "Laura Elena", 5.1,
                     "Ingenieria en Software", "Tercer Nivel"};
